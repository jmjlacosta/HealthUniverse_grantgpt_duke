...
async def process_trials(
    corpus: Literal["Duke - All Trials", "Duke - Oncology Trials", "Duke - COPD Trials"] = Form(..., description="Select the clinical trial dataset you want to process: 'All Trials' (comprehensive dataset), 'Oncology Trials' (cancer-related trials), or 'COPD Trials' (chronic obstructive pulmonary disease-related trials)"),
    patient_id: str = Form(..., description="Unique identifier for the patient (e.g., 'patient123')"),
    queries: str = Form(..., description="Narrative or medical history of the patient to be processed"),
    k: int = Form(20, description="Number of results to return (default is 20)")
):
